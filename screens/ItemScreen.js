  ...
  return (
    <SafeAreaView className="flex-1 bg-white relative">
      <ScrollView className=" flex-1 px-4 py-6">
        <View className="relative bg-white shadow-lg">
          ...
          <View className="absolute flex-row inset-x-0 top-5 justify-between px-6 ">
            <TouchableOpacity
              ...
              className="w-10 h-10 rounded-md items-center justify-center bg-white mt-2"
            >
        ...
        {data?.cuisine && (
          <View className="flex-row gap-1 items-center justify-start flex-wrap mt-2">
            {data?.cuisine.map((n) => (
              <TouchableOpacity
                key={n.key}
        ...
        <View className="space-y-2 mt-4 bg-gray-100 px-4 py-2">
          {data?.phone && (
